...
mod tests {
    ...
    fn test_rtsps_certificate_validation() {
        ...
        // Test with relaxed validation (should succeed)
        {
            ...
            assert!(
                connected,
                "Should connect with relaxed certificate validation"
            );
        }
    }
    ...
    fn test_rtsps_fallback_to_rtsp() {
        ...
        harness
            .set_property("location", "rtsp://127.0.0.1:8554/videotestsrc")
            .unwrap();
        harness.force_reconnect().unwrap();
        ...
        assert!(
            connected,
            "Should connect via regular RTSP after RTSPS failure"
        );
    }
    ...
    fn test_rtsps_with_racing() {
        ...
        harness
            .set_property("racing-strategy", "first-wins")
            .unwrap();
        ...
        println!(
            "RTSPS racing stats: attempts={}, failures={}, successes={}",
    ...
    fn test_rtsps_adaptive_learning() {
        ...
        // Verify learning persists for RTSPS
        {
            ...
            assert!(
                connected,
                "Should connect quickly with learned RTSPS strategy"
            );
            assert!(
                connect_time < Duration::from_secs(5),
                "Learned strategy should be fast"
            );
        }
    }
