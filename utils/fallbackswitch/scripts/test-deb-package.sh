#!/bin/bash
# Test script for validating gst-plugin-fallbackswitch Debian package
...
ldd /usr/lib/*/gstreamer-1.0/libgstfallbackswitch.so | head -10
...
if gst-inspect-1.0 fallbackswitch 2>/dev/null; then
...
test_local_install() {
    ...
    sudo dpkg -r gst-plugin-fallbackswitch
